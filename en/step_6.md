...
Once your project has been successfully created in the learning admin database you can begin to create project using VS Code.

Open GitHub Desktop
Current Repository - drop down arrow 
Add - drop down arrow
Clone Repository

Open Finder
Open GitHub folder
There should be a new folder directory in there for your newly created project
